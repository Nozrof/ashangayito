...
const UserMenu = ({ anchorPosition, userDetails, isUserMenuOpen, setIsUserMenuOpen, logOut }) => {
	const classes = useStyles();
	const isLoggedIn = Boolean(userDetails.uName);
	...
	const UserMenu = [
		<MenuItem
			...
			<ListItemAvatar>
				<Avatar alt='User Profile Picture' src={userDetails.avatar} />
			</ListItemAvatar>
	...
	const NoUserMenu = [
		<MenuItem
			...
			<ListItemText secondary='Sign up to join the community' />
		</MenuItem>,
